...
async def process_user_input(update: Update, context: ContextTypes.DEFAULT_TYPE, user_text: str):
    ...
    try:
        ...
        system_prompt = (
            ...
            "- **ADVANCED CAPABILITY (Reflection):** You always 'reflect' internally before giving complex advice to catch your own mistakes.\n"
            "- **ADVANCED CAPABILITY (Reasoning):** For complex mathematical, logical, or deeply analytic problems, you engage 'Deep-Think' mode to break down every step of the problem.\n"
            "- **ADVANCED CAPABILITY (Background Tasks):** If {user_name} asks you to do something that will take a long time (like 'review 50 papers', 'do a deep dive on X', or 'spend 2 hours researching'), use `start_background_task` to spawn a worker agent that runs asynchronously in the background. Do this for ANY complex multi-step research request.\n\n"
